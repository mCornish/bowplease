Login = React.createClass({
    componentDidMount() {
        Modules.client.login.withEmail( { form: "[data-hook=login-form]" } );
    },
    getInitialState() {
        return {
            passText: 'SHOW',
            ...
            <div className="login-form out-left">
                <div className="row">
                    <div className="col-xs-12 col-md-6 col-md-offset-3">
                        <button className="login__facebook button button--addon col-xs-12" type="button" onClick={this.facebookLogin}>
                            <div className="login__icon login__facebook-icon button--addon__addon col-xs-3"><i className="fa fa-facebook"></i>
                            </div>
                ...
                <form className="row row--margin" data-hook="login-form" onSubmit={this.handleSubmit}>
                    <div className="col-xs-12 col-md-6 col-md-offset-3">
